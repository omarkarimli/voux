                                  ...
                                  Row(
                                      ...
                                      children: [
                                        ...
                                        if (viewModel.totalPrice > 0)
                                          SelectableText(viewModel.totalPrice.toStringAsFixed(2).toFormattedPrice(), style: Theme.of(context).textTheme.headlineLarge?.copyWith(color: Theme.of(context).colorScheme.onSecondaryContainer)),
                                      ]
                                  ),
                                  SizedBox(height: 24),
                                  Column(
