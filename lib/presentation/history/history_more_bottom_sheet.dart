...
import 'history_more_bottom_sheet_view_model.dart';

class HistoryMoreBottomSheet extends StatefulWidget {
  final List<ClothingItemFloorModel> clothingItemFloorModels;

  const HistoryMoreBottomSheet({
    super.key,
    required this.clothingItemFloorModels
  });

  @override
  _HistoryMoreBottomSheetState createState() => _HistoryMoreBottomSheetState();
}

class _HistoryMoreBottomSheetState extends State<HistoryMoreBottomSheet> {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) {
        final viewModel = HistoryMoreBottomSheetViewModel(
            clothingItemFloorModels: widget.clothingItemFloorModels,
            clothingItemHistoryDao: locator.get()
        );
        return viewModel;
      },
      child: Consumer<HistoryMoreBottomSheetViewModel>(
