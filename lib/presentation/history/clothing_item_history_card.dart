...
class ClothingItemHistoryCard extends StatefulWidget {
  ...
  @override
  State<ClothingItemHistoryCard> createState() => _ClothingItemHistoryCardState();
}

class _ClothingItemHistoryCardState extends State<ClothingItemHistoryCard> {
