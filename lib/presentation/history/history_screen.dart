...
import 'package:voux/presentation/history/clothing_item_history_card.dart';
import 'package:voux/presentation/history/history_view_model.dart';
...
class HistoryScreen extends StatefulWidget {
  ...
  static const routeName = '/${Constants.history}';
...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!initialized) {
      vm = Provider.of<HistoryViewModel>(context, listen: false); // on true, don't work checkbox
  ...
  Widget buildWishlistItemsList() {
    return vm.wishlistItems.isEmpty
        ...
        child: Center(
            child: Column(
              ...
              children: [
                ...
                Text("No items in history".tr(), style: Theme.of(context).textTheme.bodyLarge)
              ],
            )
        )
    )
        : Column(
      spacing: 8,
      children: vm.wishlistItems.map((item) => ClothingItemHistoryCard(
